...
void BowlingAlley::Start()
{
    ...
    guardRails->  AddTexture(Assets::GetTexture(PNG_Bowling_Alley_Rails));
    walls->       AddTexture(Assets::GetTexture(PNG_Bowling_Alley_Walls));
    lightWalls->  AddTexture(Assets::GetTexture(PNG_Bowling_Alley_Walls));
    carpet->      AddTexture(Assets::GetTexture(PNG_Bowling_Alley_Carpet));
    panel->       AddTexture(Assets::GetTexture(PNG_Bowling_Alley_Panel));
    gutterTop->   AddTexture(Assets::GetTexture(PNG_Bowling_Alley_GutterBot));
    gutterBot->   AddTexture(Assets::GetTexture(PNG_Bowling_Alley_GutterBot));
    alley->       AddTexture(Assets::GetTexture(PNG_Bowling_Alley_Alley));
    back->        AddTexture(Assets::GetTexture(PNG_Bowling_Alley_Back));
    ballReturn->  AddTexture(Assets::GetTexture(PNG_Bowling_Alley_BallReturn));
    balls->       AddTexture(Assets::GetTexture(PNG_Bowling_Alley_Balls));
    ballsStandee->AddTexture(Assets::GetTexture(PNG_Bowling_Alley_BallsStandee));
    bench->       AddTexture(Assets::GetTexture(PNG_Bowling_Alley_Bench));
    chairs->      AddTexture(Assets::GetTexture(PNG_Bowling_Alley_Chairs));
    decals->      AddTexture(Assets::GetTexture(PNG_Bowling_Alley_Decals));
    tableTop->    AddTexture(Assets::GetTexture(PNG_Bowling_Alley_TableTop));
    tableBot->    AddTexture(Assets::GetTexture(PNG_Bowling_Alley_TableBot));
    trash->       AddTexture(Assets::GetTexture(PNG_Bowling_Alley_Trash));
